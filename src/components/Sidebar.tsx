      ...
      {!collapsed && (
        <div className="flex items-center justify-between px-3 py-3">
          ...
          >
            ...
            <span className="text-sm font-semibold text-gray-800 dark:text-gray-50">ww</span>
            <ChevronDown size={14} className="text-gray-400 dark:text-gray-500" />
          </button>
          <div className="flex items-center gap-1">
            <button
              className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 dark:text-gray-300 hover:text-gray-700 transition-colors"
              title="通知"
            >
              <Bell size={18} />
            </button>
        ...
        {!collapsed && favoriteProjects.length > 0 && (
          <div className="mt-4">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1 text-xs font-semibold text-gray-500 dark:text-gray-300 uppercase tracking-wider hover:text-gray-700 transition-colors w-full"
            >
        ...
        {collapsed ? (
          <div className="flex flex-col items-center gap-1">
            <button
              ...
              className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 dark:text-gray-300 hover:text-gray-700 transition-colors"
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1">
              <button
                onClick={() => onViewChange('settings')}
                className="flex items-center gap-2 flex-1 px-3 py-2 rounded-lg text-sm text-gray-600 dark:text-gray-200 hover:bg-gray-100 transition-colors"
              >
